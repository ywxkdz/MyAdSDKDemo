...
@property (strong, nonatomic)id<MSFeedAdMeta>adModel;
...
- (void)customAdModel:(id<MSFeedAdMeta>)adModel{
    ...
    CGSize titleSize =  [FeedVideoView getTextSize:adModel.metaTitle fontSize:17 maxChatWidth:textWidth];
    CGSize contentSize =  [FeedVideoView getTextSize:adModel.metaContent fontSize:16 maxChatWidth:textWidth];
...
+ (CGFloat)heightCellForRow:(id<MSFeedAdMeta>)adModel width:(CGFloat)width {
    ...
    CGSize titleSize =  [self getTextSize:adModel.metaTitle fontSize:17 maxChatWidth:textWidth];
    CGSize contentSize =  [self getTextSize:adModel.metaContent fontSize:16 maxChatWidth:textWidth];
